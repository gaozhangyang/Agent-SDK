        ...
        for (const match of jsonBlockMatches.reverse()) {
            try {
                ...
                if (parsed.strategies || parsed.permissions !== undefined) {
                    ...
                    if (strategiesData.level)
                        config.level = strategiesData.level;
                    ...
                    if (strategiesData.mode_fsm)
                        config.mode_fsm = strategiesData.mode_fsm;
                    if (strategiesData.permission_fsm)
                        config.permission_fsm = strategiesData.permission_fsm;
                    if (strategiesData.harness)
                        config.harness = strategiesData.harness;
                    if (strategiesData.error_classifier)
                        config.error_classifier = strategiesData.error_classifier;
